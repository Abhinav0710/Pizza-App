...
function initAdmin(socket) {
  ...
  } //Map is used to return an array of all the items/lists
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    var dataProp = status.dataset.status; //Class added
    ...
    if (dataProp === order.status) {
      stepCompleted = false; //Adding the time of last finished step

      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatedAt).format('hh:mm A');
      status.appendChild(time); //Current shifted to next
...
__webpack_require__(/*! C:\Users\home\Desktop\Node projects\Realtimepizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\home\Desktop\Node projects\Realtimepizza\resources\scss\app.scss */"./resources/scss/app.scss");
